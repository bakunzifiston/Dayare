        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if ($contract->isEmployeeContract() && $contract->employee)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200/60 p-6">
                    ...
                    <dl class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <div><dt class="text-sm font-medium text-slate-500">{{ __('Employee') }}</dt><dd class="mt-1 text-sm text-slate-900"><a href="{{ route('employees.show', $contract->employee) }}" class="text-indigo-600 hover:underline">{{ $contract->counterparty_name }}</a></dd></div>
                        @if ($contract->facility)<div><dt class="text-sm font-medium text-slate-500">{{ __('Assigned facility') }}</dt><dd class="mt-1 text-sm text-slate-900"><a href="{{ route('businesses.facilities.show', [$contract->facility->business, $contract->facility]) }}" class="text-indigo-600 hover:underline">{{ $contract->facility->facility_name }}</a></dd></div>@endif
                        ...
                        @if ($contract->hygiene_training_status)<div><dt class="text-sm font-medium text-slate-500">{{ __('Hygiene training status') }}</dt><dd class="mt-1 text-sm text-slate-900">{{ $contract->hygiene_training_status }}</dd></div>@endif
                        ...
                        @if ($contract->signed_contract_file)<div><dt class="text-sm font-medium text-slate-500">{{ __('Signed contract file') }}</dt><dd class="mt-1 text-sm text-slate-900">{{ $contract->signed_contract_file }}</dd></div>@endif
                    </dl>
                </div>
            @endif
            ...
            @if ($contract->isSupplierContract())
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-slate-200/60 p-6">
                    ...
                    <dl class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <div><dt class="text-sm font-medium text-slate-500">{{ __('Supplier') }}</dt><dd class="mt-1 text-sm text-slate-900"><a href="{{ route('suppliers.show', $contract->supplier) }}" class="text-indigo-600 hover:underline">{{ $contract->counterparty_name }}</a></dd></div>
                        ...
                        @if ($contract->facility)<div><dt class="text-sm font-medium text-slate-500">{{ __('Delivery location') }}</dt><dd class="mt-1 text-sm text-slate-900"><a href="{{ route('businesses.facilities.show', [$contract->facility->business, $contract->facility]) }}" class="text-indigo-600 hover:underline">{{ $contract->facility->facility_name }}</a></dd></div>@endif
