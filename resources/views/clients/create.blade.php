        ...
        <form method="POST" action="{{ route('clients.store') }}" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="country" name="country" type="text" class="mt-1 block w-full" :value="old('country')" required placeholder="e.g. Rwanda, Uganda, Kenya" />
                    <x-input-error class="mt-2" :messages="$errors->get('country')" />
                </div>
                <div>
                    <x-input-label for="address_line_1" :value="__('Address line 1')" />
                    <x-text-input id="address_line_1" name="address_line_1" type="text" class="mt-1 block w-full" :value="old('address_line_1')" />
