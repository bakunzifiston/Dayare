<div class="bucha-wizard-form">
    <x-wizard-section :title="__('VIBE metadata')" :subtitle="__('Tracking fields used by the VIBE pathway.')">
        <x-wizard-field for="vibe_unique_id" :label="__('VIBE unique ID')" :hint="__('Assigned automatically after the business is saved.')">
            <input id="vibe_unique_id" name="vibe_unique_id" type="text" class="bucha-wizard-input bg-slate-50 text-slate-600" value="{{ old('vibe_unique_id') }}" readonly />
        ...
        <div class="bucha-wizard-grid">
            <x-wizard-field for="vibe_commencement_date" :label="__('VIBE commencement date')">
                <input id="vibe_commencement_date" name="vibe_commencement_date" type="date" class="bucha-wizard-input" data-wizard-track value="{{ old('vibe_commencement_date') }}" />
        ...
        <x-wizard-field for="vibe_comments" :label="__('VIBE comments')">
            <textarea id="vibe_comments" name="vibe_comments" rows="4" class="bucha-wizard-input" data-wizard-track">{{ old('vibe_comments') }}</textarea>
