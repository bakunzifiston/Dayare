            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="post" action="{{ route('businesses.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="business_name" name="business_name" type="text" class="mt-1 block w-full" :value="old('business_name')" required />
                    ...
                    <div class="flex gap-4">
                        <x-primary-button>{{ __('Register Business') }}</x-primary-button>
