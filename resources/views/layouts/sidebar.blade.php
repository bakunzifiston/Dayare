@php
    ...
    $tenantNav = [
        ...
        [
            ...
            'children' => [
                ...
                ['label' => __('Daily sales'), 'route' => 'finance.sales.index', 'icon' => 'clipboard', 'permission' => 'manage_ar_invoices', 'routeIs' => ['finance.sales.*']],
                ['label' => __('AR invoices'), 'route' => 'finance.invoices.index', 'icon' => 'clipboard', 'permission' => 'manage_ar_invoices', 'routeIs' => ['finance.invoices.*']],
                ['label' => __('EBM invoices'), 'route' => 'finance.ebm.index', 'icon' => 'clipboard', 'permission' => 'manage_ar_invoices', 'routeIs' => ['finance.ebm.*']],
                ['label' => __('AP payables'), 'route' => 'finance.payables.index', 'icon' => 'clipboard-list', 'permission' => 'manage_ap_payables', 'routeIs' => ['finance.payables.*', 'finance.casual-workers.*']],
                ['label' => __('Expenses'), 'route' => 'finance.expenses.index', 'icon' => 'clipboard-list', 'permission' => 'manage_ap_payables', 'routeIs' => ['finance.expenses.*']],
    ...
    if ($isSuperAdmin && $user) {
        $superAdminNav = [
            ...
            ['label' => __('Users'), 'route' => 'super-admin.tenants.overview', 'icon' => 'user', 'module' => \App\Models\User::SUPER_ADMIN_MODULE_USERS, 'routeIs' => ['super-admin.tenants.overview', 'super-admin.tenants.index', 'super-admin.tenants.show']],
