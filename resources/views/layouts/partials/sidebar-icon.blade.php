...
@elseif ($icon === 'clipboard' || $icon === 'clipboard-list')
...
@elseif ($icon === 'shield-check')
    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.46 2.846a1 1 0 011.08 0l7.5 4.5a1 1 0 01.47.854V12c0 4.418-2.865 8.166-7.5 9.69C7.865 20.166 5 16.418 5 12V8.2a1 1 0 01.47-.854l7.5-4.5z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4"/></svg>
@elseif ($icon === 'intake')
...
@elseif ($icon === 'alert')
    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M5.07 19h13.86c1.54 0 2.5-1.67 1.73-3L13.73 5c-.77-1.33-2.69-1.33-3.46 0L3.34 16c-.77 1.33.19 3 1.73 3z"/></svg>
@elseif ($icon === 'clock')
...
@elseif ($icon === 'qrcode')
    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h6v6H4V4zm10 0h6v6h-6V4zM4 14h6v6H4v-6zm10 0h2v2m2-2v2m-2 2h2m2-2v2m-2 2h2m2-2v2m-2 2h2"/></svg>
@elseif ($icon === 'chart')
