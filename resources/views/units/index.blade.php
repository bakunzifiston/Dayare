        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        <h3 class="text-base font-semibold text-gray-900">{{ __('Units list') }}</h3>
                ...
                <div class="px-6 py-5 space-y-6">
                    ...
                    <form method="POST" action="{{ route('units.store') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" placeholder="e.g. Kilogram, Heads" required />
                            <x-input-error class="mt-2" :messages="$errors->get('name')" />
                        </div>
                        <div>
                            <x-input-label for="code" :value="__('Code')" />
                            <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code')" placeholder="e.g. kg, heads" required />
                            <p class="mt-1 text-xs text-gray-400">{{ __('Short code used in forms.') }}</p>
