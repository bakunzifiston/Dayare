        ...
        <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="notes" name="notes" rows="2" class="mt-1 block w-full rounded-lg border-gray-300 focus:border-[#3B82F6] focus:ring-[#3B82F6]">{{ old('notes', $supplier->notes) }}</textarea>
