        ...
        <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="notes" name="notes" rows="2" class="mt-1 block w-full rounded-lg border-gray-300 focus:border-bucha-primary focus:ring-bucha-primary">{{ old('notes') }}</textarea>
