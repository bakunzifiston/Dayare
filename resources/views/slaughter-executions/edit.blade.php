    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="post" action="{{ route('slaughter-executions.update', $execution) }}" class="space-y-6">
                    @csrf
                    @method('put')
                    ...
                    <div>
                        ...
                        <x-text-input id="actual_animals_slaughtered" name="actual_animals_slaughtered" type="number" min="0" class="mt-1 block w-full" :value="old('actual_animals_slaughtered', $execution->actual_animals_slaughtered)" required />
