                    ...
                    <ul class="divide-y divide-slate-100">
                        @foreach ($batches as $batch)
                            <li class="p-4 flex justify-between items-center hover:bg-slate-50/80 transition-colors">
                                <div>
                                    <a href="{{ route('batches.show', $batch) }}" class="font-medium text-slate-900 hover:text-bucha-primary">
                                        {{ $batch->batch_code }}
                                    </a>
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('batches.show', $batch) }}" class="text-sm text-bucha-primary hover:text-indigo-900">{{ __('View') }}</a>
