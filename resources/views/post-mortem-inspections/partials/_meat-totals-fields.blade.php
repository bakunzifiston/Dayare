...
<div id="aggregate-counts-section" @class(['grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4', 'hidden' => $hidden ?? false])>
    <div>
        ...
        <x-text-input id="total_examined" name="total_examined" type="number" min="0" step="0.01" class="mt-1 h-9 block w-full rounded-lg border-slate-200 text-sm" :value="old('total_examined', $examinedValue)" required />
    ...
    <div>
        ...
        <x-text-input id="approved_carcass_kg" type="number" min="0" step="0.01" class="mt-1 h-9 block w-full rounded-lg border-slate-200 text-sm" :value="old('approved_carcass_kg', $carcassApprovedValue)" />
    ...
    <div>
        ...
        <x-text-input id="approved_other_meat_kg" type="number" min="0" step="0.01" class="mt-1 h-9 block w-full rounded-lg border-slate-200 text-sm" :value="old('approved_other_meat_kg', $otherMeatApprovedValue)" />
    ...
    <div>
        ...
        <x-text-input id="condemned_quantity" name="condemned_quantity" type="number" min="0" step="0.01" class="mt-1 h-9 block w-full rounded-lg border-slate-200 text-sm" :value="old('condemned_quantity', $condemnedValue)" required />
