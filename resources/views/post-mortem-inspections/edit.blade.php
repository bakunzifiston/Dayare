        ...
        <section class="overflow-hidden rounded-bucha border border-slate-200 bg-white">
            <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-4 py-3">
                <div>
                    ...
                    <p class="text-xs text-slate-500">{{ $inspection->batch->batch_code }}</p>
                </div>
            ...
            <div class="px-4 py-4">
                ...
                <form method="post" action="{{ route('post-mortem-inspections.update', $inspection) }}" class="space-y-5" id="post-mortem-edit-form" novalidate>
                    @csrf
                    @method('put')
