...
<body>
    ...
    <table width="100%"><tr><td>
        ...
        <div class="section"><h3>{{ __('Farm information') }}</h3><table class="grid"><tr><td><strong>{{ __('Farm') }}</strong></td><td>{{ $summary['farm']?->name ?: '—' }}</td></tr><tr><td><strong>{{ __('Owner') }}</strong></td><td>{{ $summary['business']?->ownerIndividualDisplayName() ?: '—' }}</td></tr><tr><td><strong>{{ __('Location') }}</strong></td><td>{{ $summary['farm_location'] }}</td></tr></table></div>
