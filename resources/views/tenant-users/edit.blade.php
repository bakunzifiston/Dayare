                    ...
                    <div class="space-y-2">
                        @foreach ($businesses as $b)
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="business_ids[]" value="{{ $b->id }}" @checked(in_array($b->id, old('business_ids', $userBusinessIds))) class="rounded border-gray-300 focus:ring-[#3B82F6]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                @foreach ($permissions as $permName => $permLabel)
                                    <label class="flex items-center gap-2 text-sm">
                                        <input type="checkbox" name="permissions[]" value="{{ $permName }}" @checked(in_array($permName, old('permissions', $userPermissionNames))) class="rounded border-gray-300 focus:ring-[#3B82F6]">
