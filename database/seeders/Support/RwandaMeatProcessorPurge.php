...
/**
 * Removes all data created by {@see RwandaMeatProcessorDemoSeeder}.
 */
class RwandaMeatProcessorPurge
{
    public static function run(): int
    {
        ...
        $certIds = Certificate::query()
            ->where('certificate_number', 'like', 'CERT-NPM%')
            ->pluck('id');
        ...
        DB::transaction(function () use (
            ...
            RicaMonthlyInspectionReport::query()->whereIn('facility_id', $facilityIds)->delete();
            ...
            User::query()
                ->where('email', 'like', '%@nyagataprime.rw')
                ->delete();
        });
