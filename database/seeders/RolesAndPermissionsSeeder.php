...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command?->info('Roles and permissions seeded: org_admin, operations_manager, compliance_officer, inspector, transport_manager, accountant, sales_marketing_officer.');
    }
}
