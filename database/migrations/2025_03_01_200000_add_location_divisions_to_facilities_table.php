...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Replace manual district/sector with Rwanda selection: Province, District, Sector, Cell, Village.
     */
    public function up(): void
    {
        Schema::table('facilities', function (Blueprint $table) {
            $table->foreignId('country_id')->nullable()->after('sector')->constrained('administrative_divisions')->nullOnDelete();
