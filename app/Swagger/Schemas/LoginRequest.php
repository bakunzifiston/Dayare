...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'business_id', type: 'integer', nullable: true, minimum: 1, description: 'Optional workspace context; must be in the user\'s accessible businesses.', example: 12),
    ],
    type: 'object',
)]
