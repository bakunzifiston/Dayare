    ...
    requestBody: new OA\RequestBody(
        ...
        content: new OA\MediaType(
            ...
            schema: new OA\Schema(
                ...
                properties: [
                    new OA\Property(property: 'type', type: 'string', enum: ['farmer', 'processor', 'logistics', 'butcher'], nullable: true, example: 'processor', description: 'Optional. Defaults to `processor` when omitted.'),
