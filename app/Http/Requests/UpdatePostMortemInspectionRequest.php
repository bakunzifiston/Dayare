...
class UpdatePostMortemInspectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'item_outcomes.*.condemned_organs' => ['nullable', 'array'],
            'item_outcomes.*.condemned_organs.*.organ_name' => ['nullable', 'string', 'max:255'],
            'item_outcomes.*.condemned_organs.*.weight_kg' => ['nullable', 'numeric', 'min:0.1', 'max:9999'],
