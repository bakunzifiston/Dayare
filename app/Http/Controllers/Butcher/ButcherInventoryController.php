...
class ButcherInventoryController extends Controller
{
    ...
    public function temperaturesIndex(Request $request): View|RedirectResponse
    {
        ...
        return view('butcher.inventory.temperatures.index', [
            'business' => $business,
            'logs' => $logs,
    ...
    public function temperaturesStore(StoreButcherTemperatureLogRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('butcher.inventory.temperatures.index')
            ->with('status', $message);
    }
    ...
    public function disposalsIndex(Request $request): View|RedirectResponse
    {
        ...
        return view('butcher.inventory.disposals.index', [
            'business' => $business,
            'disposals' => $disposals,
    ...
    public function disposalsStore(StoreButcherDisposalLogRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('butcher.inventory.disposals.index')
